...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        # kb.append([InlineKeyboardButton(text='Support', url='https://t.me/Bebas_Gabut'),
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                ...
                                url='https://t.me/Bebas_Gabut',
                            ),
                            InlineKeyboardButton(
                                text=gs(chat.id, "updates_channel_link_btn"),
                                url="https://t.me/Rezabotlist",
                            ),
                            InlineKeyboardButton(
                                text=gs(chat.id, "src_btn"),
                                url="https://youtu.be/dQw4w9WgXcQ?si=J2HBXFhXXGIZD7GL/",
                            ),
                        ],
                        [
                            InlineKeyboardButton(
            ...
            if args[0].lower() == "help":
                ...
                help_buttons.append(
                    [InlineKeyboardButton(text="Back", callback_data="help_back"),
                     InlineKeyboardButton(text='Support', url='https://t.me/Bebas_Gabut')]
                )
                send_help(
                    chat.id,
                    text,
